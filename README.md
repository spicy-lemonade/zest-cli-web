...
This is the **marketing website** for Zest CLI - a command-line tool that converts natural language into shell commands using locally-trained small language models. The site showcases the product's features, pricing, and download options.
