...
export const PrivacyPolicyPage: React.FC = () => {
  usePageMeta({
    ...
    description: "Zest CLI privacy policy — all processing is local, no data is transmitted to servers, no tracking.",
  });

  return (
  <section className="pt-32 pb-24 px-6 max-w-4xl mx-auto animate-in fade-in duration-500">
    <PageHeader title="Privacy Policy" icon={<Shield className="w-10 h-10 text-white" />} />
    <div className="prose prose-slate lg:prose-xl font-medium text-slate-600 space-y-8">
      <div>
        <h2 className="text-slate-900 font-black">1. Local Processing</h2>
