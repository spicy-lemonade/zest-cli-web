...
const DEMO_COMMANDS = [
  ...
  { input: "zest stop and remove all Docker containers", output: "docker rm -f $(docker ps -aq)" },
...
export const Terminal: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-yellow-500/10">
      ...
      <div className="p-8 h-80 flex flex-col justify-start text-left">
        <div className="flex items-start gap-3 mb-4 text-left">
          <span className="text-yellow-500 font-black mono select-none">~</span>
        ...
        {step === 'thinking' && (
          <div className="flex items-center gap-2 text-left">
            ...
            <span className="text-red-500 font-bold mono">Thinking...</span>
          </div>
        )}
          ...
          <div className="animate-in fade-in slide-in-from-top-2 duration-300 space-y-3 text-left">
             <div className="flex flex-col gap-1 items-start text-left">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-800 font-bold mono">Suggested Command:</span>
                </div>
                <div className="ml-8 text-slate-900 mono text-sm font-bold text-left break-all">
                  {DEMO_COMMANDS[index].output}
                </div>
             </div>
             <div className="flex items-center gap-2 pt-2 text-left">
                <span className="text-lg">🍋</span>
                <span className="text-slate-800 font-bold mono">Execute? [y/n]: <span className="text-slate-900">y</span></span>
             </div>
          </div>
        )}
      </div>
